...
class ModalDeletePelanggan extends StatelessWidget {
  final OnDataAddedCallback onDataAdded;
  final String idPelanggan;

  const ModalDeletePelanggan(
      {Key key, @required this.onDataAdded, @required this.idPelanggan})
      : super(key: key);
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ElevatedButton(
                  onPressed: () {
                    HttpPelanggan.deletePelanggan(idPelanggan).then(
                      (value) {
