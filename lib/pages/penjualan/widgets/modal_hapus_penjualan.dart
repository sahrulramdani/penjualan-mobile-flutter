...
class ModalDeletePenjualan extends StatelessWidget {
  final OnDataAddedCallback onDataAdded;
  final String idPenjualan;

  const ModalDeletePenjualan(
      {Key key, @required this.onDataAdded, @required this.idPenjualan})
      : super(key: key);
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ElevatedButton(
                  onPressed: () {
                    HttpPenjualan.deletePenjualan(idPenjualan).then(
                      (value) {
